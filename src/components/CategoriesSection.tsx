      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Browse our comprehensive catalog organized by technology vendor and domain expertise.
          </p>
        </motion.div>
          ...
          {categories.map((cat, i) => (
            ...
            >
              <Link
                ...
                className="group block bg-card border border-border/50 rounded-xl p-5 text-center hover:border-primary/30 hover:shadow-glow transition-all duration-300"
              >
